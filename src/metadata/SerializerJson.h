...
namespace OpenLogReplicator {
    ...
    protected:
        ...
        void deserializeXdbXNm(Metadata* metadata, SchemaXml* schemaXml, const std::string& fileName, const rapidjson::Value& xdbXNmJson);
        void deserializeXdbXPt(Metadata* metadata, SchemaXml* schemaXml, const std::string& fileName, const rapidjson::Value& xdbXPtJson);
        void deserializeXdbXQn(Metadata* metadata, SchemaXml* schemaXml, const std::string& fileName, const rapidjson::Value& xdbXQnJson);
