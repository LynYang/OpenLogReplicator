...
namespace OpenLogReplicator {
    ...
    void ReplicatorOnline::createSchema() {
        ...
        std::list<std::string> msgs;
        {
            ...
            for (SchemaElement* element : metadata->schemaElements)
                createSchemaForTable(metadata->firstDataScn, element->owner, element->table, element->keys, element->keysStr, element->condition,
    ...
    void ReplicatorOnline::createSchemaForTable(typeScn targetScn, const std::string& owner, const std::string& table, const std::vector<std::string>& keys,
                                                const std::string& keysStr, const std::string& condition, typeOptions options, std::list<std::string> &msgs) {
        if (ctx->trace & TRACE_REDO)
        ...
        metadata->schema->buildMaps(owner, table, keys, keysStr, condition, options, msgs, metadata->suppLogDbPrimary,
